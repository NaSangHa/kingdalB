...
<body>
    ...
    <div class="container-fluid ">
        <div class="row align-items-center justify-content-center ">
            <div class="col text-center pageTitle ">배달 현황</div>
        </div>
    </div>
    ...
    <div class="container-fluid ">
        <div class="row justify-content-center">
            <div class="col-10 row deliveryStatusWrap ">
                <div class="col-1 row align-items-center justify-content-end deliveryStatusBarWrap ">
                    <div class="row align-items-end deliveryStatusBar">
                        <div class="col deliveryStatusBarAct" style="height: ${deliveryBar}%;"></div>
                    </div>
                </div>
                <div class="col-2 ">
                    <div class="deliveryStatusBarContent ">
                        도착예정 <span class="deliveryStatusBarContent_time">${endTime }</span>
                    </div>
                    <div class="deliveryStatusBarContentM ">
                        배달시작 <span class="deliveryStatusBarContent_time">${middleTime }</span>
                    </div>
                    <div class="deliveryStatusBarContent ">
                        주문완료 <span class="deliveryStatusBarContent_time">${startTime }</span>
                    </div>
                </div>
                <div class="col text-center deliveryStatusMap ">
                    <img src="/upload/InDelivery_sample2.png" alt="">
                </div>
            </div>
        </div>
    </div>
