...
class _MyInfoState extends State<MyInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            "$imgIPAddress$profileimg",
                            fit: BoxFit.fitHeight,
                          ),
                        ),
                      ),
                      SizedBox(width: 15,),
                      Expanded(child: Text("$nickname", style: TextStyle(fontSize: 25),)),
                      Text("수정"),
                      SizedBox(width: 5,),
                      Image.asset("./assets/images/modify.png", width: 20,),
                    ],
                  ),
                ),
                Hr(),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          child: Column(
                            children: [
                              Text("$myRecentOrder", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Text("최근주문", style: TextStyle(color: Colors.grey.shade500),),
                            ],
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Container(
                          child: Column(
                            children: [
                              Text("$myLike", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Text("찜목록", style: TextStyle(color: Colors.grey.shade500),),
                            ],
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Container(
                          child: Column(
                            children: [
                              Text("$myReview", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Text("리뷰", style: TextStyle(color: Colors.grey.shade500),),
                            ],
                          ),
                        ),
                      ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/location.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                          child: Text("주소관리", style: TextStyle(fontSize: 20),)
                        )
                      ],
                    ),
                  ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/coupone.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                          child: Text("할인쿠폰", style: TextStyle(fontSize: 20),)
                        )
                      ],
                    ),
                  ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/payment.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                          child: Text("결제관리", style: TextStyle(fontSize: 20),)
                        )
                      ],
                    ),
                  ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/message.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                          child: Text("자주묻는질문", style: TextStyle(fontSize: 20),)
                        )
                      ],
                    ),
                  ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/call.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                          child: Text("고객지원", style: TextStyle(fontSize: 20),)
                        )
                      ],
                    ),
                  ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/settings.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset("./assets/images/notice.png", width: inconWidth,),
                        SizedBox(width: 15,),
                        Expanded(
      ...
      bottomNavigationBar: BottomNavBar(context, widget.bottomNavIndex, widget.loginId),
    );
  }

  // 내 정보 가져 가져오기
  void getMyInfo() async {
    dynamic json = await springConnecter(requestMapping: "/flutter/getMyInfo", parameter: "id=${widget.loginId}");
    var data = jsonDecode(json);
    print(data['result']);
    
    profileimg = data['result']['profileimg'];
    nickname = data['result']['nickname'];
    myReview = data['result']['myReview'];
    myLike = data['result']['myLike'];
    myRecentOrder = data['result']['myRecentOrder'];
    setState(() {});
  }
